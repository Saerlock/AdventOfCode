...
function waysToBeatRecord(input: string) : number {
...
// console.log(txtTest);
// waysToBeatRecord(txtTest);
let start: number;

start = Date.now();
console.log(`Test 1: ${waysToBeatRecord(txtTest)} should be equal to 288 | ${(Date.now() - start)}ms\n`);

// start = Date.now();
// console.log(`Test 2: ${(txtTest)} should be equal to  | ${(Date.now() - start)}ms\n`);

// // Prod
const txtProd = readInput('inputs/day6.txt');

start = Date.now();
console.log(`Prod 1: ${waysToBeatRecord(txtProd)} | ${(Date.now() - start)}ms\n`);

// start = Date.now();
// console.log(`Prod 2: ${(txtProd)} | ${(Date.now() - start)}ms\n`);
